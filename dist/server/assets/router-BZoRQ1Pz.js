...
function ThemeProvider({ children }) {
  ...
  return reactExports.createElement(ThemeContext.Provider, { value: { theme, toggle } }, children);
}
function useTheme() {
...
const appCss = "/assets/styles-CJ6Dlc98.css";
...
function RootComponent() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(ThemeProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Outlet, {}) });
}
const $$splitComponentImporter = () => import("./index-DLHOBXFn.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Personal portfolio of Alex Mercer — minimal, refined digital design and development."
    }, {
      property: "og:title",
      content: "Alex Mercer — Portfolio"
    }, {
      property: "og:description",
      content: "Selected work in design, development, and brand systems."
    }, {
      property: "og:image",
      content: "/light logo.png"
    }],
    links: [{
      rel: "icon",
      href: "/light.png"
